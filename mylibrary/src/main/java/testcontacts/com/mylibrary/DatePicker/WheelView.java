...
package testcontacts.com.mylibrary.DatePicker;
...
import testcontacts.com.mylibrary.DatePicker.adapter.AbstractWheelTextAdapter;
import testcontacts.com.mylibrary.DatePicker.adapter.WheelViewAdapter;
import testcontacts.com.mylibrary.R;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xc0ffffff,
			0xc0ffffff, 0xc0ffffff };
	...
	protected void onDraw(Canvas canvas) {
		...
		if (viewAdapter != null && viewAdapter.getItemsCount() > 0) {
			updateView();
			((AbstractWheelTextAdapter)viewAdapter).setTextColor(Color.RED);
			drawItems(canvas);
			drawCenterRect(canvas);
		}
		((AbstractWheelTextAdapter)viewAdapter).setTextColor(Color.BLACK);

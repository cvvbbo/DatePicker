...
public class DatePickerView2 {
	...
	public DatePickerView2(Context context, DatePickerListener listener){
		mContext=context;
		mListener=listener;
...
//		lp.dimAmount=0.4f;
	...
	private View getDataPick() {
		...
		View view = View.inflate(mContext, R.layout.wheel_date_picker2, null);
		//完成按钮 4.2
